...
public class OrderControllerTest {
    ...
    public void testUploadFileSuccess() throws Exception {
        String content = """
                0000000001                                      Zarelli00000001230000000111512.2420211201
        ...
        MockMultipartFile file = new MockMultipartFile("file", "data_1.txt", "text/plain", content.getBytes());
    ...
    public void testUploadFileInvalid() throws Exception {
        MockMultipartFile file = new MockMultipartFile("file", "test-files/invalid.txt", "text/plain", new byte[0]);
